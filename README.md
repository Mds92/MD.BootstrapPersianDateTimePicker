...
| **rangeSelectorStartDate**     | [undefined], Date                  | Start date of the selected range, used when `rangeSelector` is true                                                                         | new Date('2020/8/5')                                 |
| **rangeSelectorEndDate**       | [undefined], Date                  | End date of the selected range, used when `rangeSelector` is true                                                                           | new Date('2020/8/15')                                |
| **rangeSelectorMonthsToShow**  | Numeric array with 2 items, [0 ,0] | Used with `rangeSelector`, number of month before and after selected date to show, first item is for before month, second item is for after month | [1, 1]                                               |
...
| **getSelectedDate**        | Date &#124; null           | Get selected date                                              | const dateObj = dtp1Instance.getSelectedDate()                                                                                |
| **getSelectedDateRange**   | Date[]                     | Get selected date range (in `rangeSelector` mode)               | dtp1Instance.getSelectedDateRange();                                                                                          |
