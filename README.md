...
**_npm install md.bs4-persian-date-time-picker@latest_**
...
| **disable**        | void                       | Disable or enable date time picker                    | $('#id').MdPersianDateTimePicker('disable', /_isDisable_/ true);                                                   |
| **destroy**        | void                       | Dispose date time picker                              | $('#id').MdPersianDateTimePicker('destroy');                                                                       |
| **changeType**     | void                       | Switch between Persian or Gregorian calendar          | $('#id').MdPersianDateTimePicker('changeType', /_isGregorian_/ true, /_ englishNumber _/ true);                    |
