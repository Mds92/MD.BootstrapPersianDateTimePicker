...
var __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;!(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__, exports, __webpack_require__(685)], __WEBPACK_AMD_DEFINE_RESULT__ = (function (require, exports, bootstrap_1) {
    "use strict";
    ...
    var MdsPersianDateTimePicker = /** @class */ (function () {
        function MdsPersianDateTimePicker(element, setting) {
                ...
                if (setting.inLine) {
                    ...
                    if (_this.tempTitleString) {
                        if (setting.modalMode)
                            ...
                            popoverOrModalElement.querySelector('[data-mds-dtp-title]').innerHTML = _this.tempTitleString;
                        }
                        popoverOrModalElement.querySelector('[data-name="mds-dtp-body"]').removeAttribute('hidden');
                    }
                    var yearListBox = popoverOrModalElement.querySelector('[data-mds-dtp-year-list-box]');
                    yearListBox.classList.add('w-0');
                    yearListBox.innerHTML = '';
                }
            };
            this.showYearsBox = function (element) {
                ...
                var mdDatePickerContainer = setting.inLine ? element.closest('[data-mds-dtp-guid]') : element.closest('[data-mds-dtp]');
                ...
                var dateTimePickerYearsToSelectContainer = mdDatePickerContainer.querySelector('[data-mds-dtp-year-list-box]');
                _this.setPopoverHeaderHtml(element, setting, _this.getYearsBoxHeaderHtml(setting, yearsToSelectObject.yearStart, yearsToSelectObject.yearEnd));
            ...
            this.setPopoverHeaderHtml = function (element, setting, htmlString) {
                // element = المانی که روی آن فعالیتی انجام شده و باید عنوان تقویم آن عوض شود    
                if (_this.bsPopover != null) {
                    ...
                    var inlineTitleBox = element.closest('[data-mds-dtp-guid]').querySelector('[data-mds-dtp-title] .modal-title');
                    inlineTitleBox.innerHTML = htmlString;
                }
            };
            this.updateCalendarBodyHtml = function (element, setting) {
                ...
                _this.setPopoverHeaderHtml(element, setting, dtpInlineHeader.trim());
            ...
            this.changeMonth = function (element) {
                ...
                var setting = instance.setting;
                var selectedDateToShow = MdsPersianDateTimePicker.getClonedDate(setting.selectedDateToShow);
            ...
            this.selectDay = function (element) {
                ...
                var selectedDateJson = setting.selectedDate == undefined ? undefined : MdsPersianDateTimePicker.getDateTimeJson1(setting.selectedDate);
                var selectedDateToShow = setting.selectedDateToShow == undefined ? undefined : MdsPersianDateTimePicker.getClonedDate(setting.selectedDateToShow);
                var selectedDateToShowJson = selectedDateToShow == undefined ? undefined : MdsPersianDateTimePicker.getDateTimeJson1(selectedDateToShow);
                if (disabled) {
                ...
                if (!setting.inLine) {
                    ...
                    element.closest("[data-mds-dtp-guid=\"" + _this.guid + "\"]")
                        .querySelectorAll('[data-day]')
                        .forEach(function (e) { return e.removeAttribute('data-mds-dtp-selected-day'); });
                }
            ...
            this.hoverOnDays = function (e) {
                ...
                var rangeSelectorStartDate = !setting.rangeSelectorStartDate ? undefined : MdsPersianDateTimePicker.getClonedDate(setting.rangeSelectorStartDate);
                var rangeSelectorEndDate = !setting.rangeSelectorEndDate ? undefined : MdsPersianDateTimePicker.getClonedDate(setting.rangeSelectorEndDate);
            ...
            this.popoverOrModalHiddenEvent = function (e) {
                _this.disableEvents();
            };
            ...
            this.hidePopoverEvent = function (e) {
                ...
                if (element.tagName == 'HTML') {
                    MdsPersianDateTimePickerData.getAll().forEach(function (i) { return !i.setting.modalMode ? i.hide() : function () { }; });
                    return;
                }
           ...
           * @param date آبجکت تاریخ
           */
            this.convertDateToJalali = function (date) {
                var dateTimeJson1 = MdsPersianDateTimePicker.getDateTimeJson1(date);
                var jalaliJsonModel = MdsPersianDateTimePicker.toJalali(dateTimeJson1.year, dateTimeJson1.month, dateTimeJson1.day);
                return {
        ...
        MdsPersianDateTimePicker.toJalali = function (gy, gm, gd) {
            return this.d2j(this.g2d(gy, gm, gd));
        };
        MdsPersianDateTimePicker.toGregorian = function (jy, jm, jd) {
            return this.d2g(this.j2d(jy, jm, jd));
        };
        MdsPersianDateTimePicker.isValidJalaliDate = function (jy, jm, jd) {
            return jy >= -61 && jy <= 3177 &&
                jm >= 1 && jm <= 12 &&
                jd >= 1 && jd <= this.jalaliMonthLength(jy, jm);
        };
        MdsPersianDateTimePicker.isLeapJalaliYear = function (jy) {
            return this.jalCal(jy).leap === 0;
        };
        MdsPersianDateTimePicker.jalaliMonthLength = function (jy, jm) {
            if (jm <= 6)
                return 31;
            if (jm <= 11)
                return 30;
        ...
        MdsPersianDateTimePicker.jalCal = function (jy) {
        ...
        MdsPersianDateTimePicker.j2d = function (jy, jm, jd) {
            var r = this.jalCal(jy);
            return this.g2d(r.gy, 3, r.march) + (jm - 1) * 31 - this.div(jm, 7) * (jm - 7) + jd - 1;
        };
        MdsPersianDateTimePicker.d2j = function (jdn) {
        ...
        MdsPersianDateTimePicker.g2d = function (gy, gm, gd) {
        ...
        MdsPersianDateTimePicker.d2g = function (jdn) {
            var j;
            j = 4 * jdn + 139361631;
        ...
        MdsPersianDateTimePicker.div = function (a, b) {
            return ~~(a / b);
        };
        MdsPersianDateTimePicker.mod = function (a, b) {
            return a - ~~(a / b) * b;
        };
        // #endregion
        // #region Methods
        MdsPersianDateTimePicker.prototype.initializeBsPopover = function (setting) {
            ...
            setTimeout(function () {
                ...
                var datePickerBodyHtml = _this.getDateTimePickerBodyHtml(setting);
                var tempDiv = document.createElement('div');
                tempDiv.innerHTML = datePickerBodyHtml;
                var dropDowns = tempDiv.querySelectorAll('.dropdown>button');
                ...
                if (setting.modalMode == true) {
                    ...
                    _this.bsPopover = null;
                    _this.element.innerHTML = datePickerBodyHtml;
                    _this.enableInLineEvents();
                }
                else {
        ...
        MdsPersianDateTimePicker.newGuid = function () {
            return 'xxxxxxxx-xxxx-4xxx-yxxx-xxxxxxxxxxxx'.replace(/[xy]/g, function (c) {
                var r = Math.random() * 16 | 0, v = c == 'x' ? r : (r & 0x3 | 0x8);
                return v.toString(16);
            });
        };
        MdsPersianDateTimePicker.extend = function () {
            var args = [];
        ...
        MdsPersianDateTimePicker.getClonedDate = function (dateTime) {
            return new Date(dateTime.getTime());
        };
        MdsPersianDateTimePicker.getDateTimeJson1 = function (dateTime) {
            return {
        ...
        MdsPersianDateTimePicker.getDateTimeJson2 = function (dateNumber) {
            return {
        ...
        MdsPersianDateTimePicker.getDateTimeJsonPersian1 = function (dateTime) {
        ...
        MdsPersianDateTimePicker.getDateTimeJsonPersian2 = function (yearPersian, monthPersian, dayPersian, hour, minute, second) {
        ...
        MdsPersianDateTimePicker.getWeekDayName = function (englishWeekDayIndex, isGregorian) {
            if (!isGregorian)
                return this.weekDayNamesPersian[englishWeekDayIndex];
            return this.weekDayNames[englishWeekDayIndex];
        };
        MdsPersianDateTimePicker.getMonthName = function (monthIndex, isGregorian) {
            if (monthIndex < 0)
                monthIndex = 11;
        ...
        MdsPersianDateTimePicker.getWeekDayShortName = function (englishWeekDayIndex, isGregorian) {
            if (!isGregorian)
                return this.shortDayNamesPersian[englishWeekDayIndex];
            return this.shortDayNames[englishWeekDayIndex];
        };
        MdsPersianDateTimePicker.isLeapYear = function (persianYear) {
            return this.isLeapJalaliYear(persianYear);
        };
        MdsPersianDateTimePicker.getDaysInMonthPersian = function (year, month) {
        ...
        MdsPersianDateTimePicker.getDaysInMonth = function (year, month) {
            return new Date(year, month + 1, 0).getDate();
        };
        MdsPersianDateTimePicker.getLastDayDateOfPreviousMonth = function (dateTime, isGregorian) {
            var dateTimeLocal = MdsPersianDateTimePicker.getClonedDate(dateTime);
            if (isGregorian) {
                var previousMonth = new Date(dateTimeLocal.getFullYear(), dateTimeLocal.getMonth() - 1, 1), daysInMonth = MdsPersianDateTimePicker.getDaysInMonth(previousMonth.getFullYear(), previousMonth.getMonth());
                return new Date(previousMonth.getFullYear(), previousMonth.getMonth(), daysInMonth);
            }
            var dateTimeJsonPersian = MdsPersianDateTimePicker.getDateTimeJsonPersian1(dateTimeLocal);
        ...
        MdsPersianDateTimePicker.getFirstDayDateOfNextMonth = function (dateTime, isGregorian) {
            var dateTimeLocal = MdsPersianDateTimePicker.getClonedDate(dateTime);
            if (isGregorian) {
        ...
        MdsPersianDateTimePicker.getDateTime1 = function (yearPersian, monthPersian, dayPersian, hour, minute, second) {
            if (!this.isNumber(hour))
                hour = 0;
            if (!this.isNumber(minute))
                minute = 0;
        ...
        MdsPersianDateTimePicker.getDateTime2 = function (dateTimeJsonPersian) {
        ...
        MdsPersianDateTimePicker.getDateTime3 = function (dateTimeJson) {
        ...
        MdsPersianDateTimePicker.getDateTime4 = function (dateNumber, dateTime, isGregorian) {
            var dateTimeJson = MdsPersianDateTimePicker.getDateTimeJson2(dateNumber);
            if (!isGregorian) {
                var dateTimeJsonPersian = MdsPersianDateTimePicker.getDateTimeJsonPersian1(dateTime);
        ...
        MdsPersianDateTimePicker.getLesserDisableBeforeDate = function (setting) {
            // دریافت تاریخ کوچکتر
        ...
        MdsPersianDateTimePicker.getBiggerDisableAfterDate = function (setting) {
            // دریافت تاریخ بزرگتر
        ...
        MdsPersianDateTimePicker.addMonthToDateTimeJson = function (dateTimeJson, addedMonth, isGregorian) {
        ...
        MdsPersianDateTimePicker.convertToNumber1 = function (dateTimeJson) {
        ...
        MdsPersianDateTimePicker.convertToNumber2 = function (year, month, day) {
        ...
        MdsPersianDateTimePicker.convertToNumber3 = function (dateTime) {
            return MdsPersianDateTimePicker.convertToNumber1(MdsPersianDateTimePicker.getDateTimeJson1(dateTime));
        };
        MdsPersianDateTimePicker.convertToNumber4 = function (dateTime) {
        ...
        MdsPersianDateTimePicker.correctOptionValue = function (optionName, value) {
        ...
        MdsPersianDateTimePicker.getShortHour = function (hour) {
            var shortHour;
            if (hour > 12)
                shortHour = hour - 12;
            else
        ...
        MdsPersianDateTimePicker.getAmPm = function (hour, isGregorian) {
            var amPm;
            if (hour > 12) {
                if (isGregorian)
                    amPm = 'PM';
        ...
        MdsPersianDateTimePicker.addMonthToDateTime = function (dateTime, addedMonth, isGregorian) {
            var dateTimeJson;
            if (!isGregorian) {
        ...
        MdsPersianDateTimePicker.isNumber = function (n) {
            return !isNaN(parseFloat(n)) && isFinite(n);
        };
        MdsPersianDateTimePicker.toPersianNumber = function (inputNumber1) {
            /* ۰ ۱ ۲ ۳ ۴ ۵ ۶ ۷ ۸ ۹ */
            if (!inputNumber1)
                return '';
        ...
        MdsPersianDateTimePicker.zeroPad = function (nr, base) {
            if (nr == undefined || nr == '')
                return '00';
        ...
        MdsPersianDateTimePicker.getDateTimeString = function (dateTimeJson, format, isGregorian, englishNumber) {
            if (isGregorian)
                englishNumber = true;
        ...
        MdsPersianDateTimePicker.getSelectedDateTimeTextFormatted = function (setting) {
            if (setting.selectedDate == undefined)
                return '';
            if (!setting.enableTimePicker) {
                setting.selectedDate.setHours(0);
        ...
        MdsPersianDateTimePicker.getSelectedDateFormatted = function (setting) {
        ...
        MdsPersianDateTimePicker.getDisabledDateObject = function (setting) {
        ...
        MdsPersianDateTimePicker.setSelectedData = function (setting) {
        ...
        MdsPersianDateTimePicker.prototype.setModalHtml = function (title, datePickerBodyHtml, setting) {
            ...
            if (prevModalElement == null) {
                var modalHtml = MdsPersianDateTimePicker.modalHtmlTemplate;
        ...
        MdsPersianDateTimePicker.prototype.getYearsBoxBodyHtml = function (setting, yearToStart) {
            ...
            var selectedDateToShow = MdsPersianDateTimePicker.getClonedDate(setting.selectedDateToShow);
            var disabledDateObj = MdsPersianDateTimePicker.getDisabledDateObject(setting);
            var disableBeforeDateTimeJson = disabledDateObj[0];
            var disableAfterDateTimeJson = disabledDateObj[1];
            var html = MdsPersianDateTimePicker.dateTimePickerYearsToSelectHtmlTemplate;
            var yearsBoxHtml = '';
            ...
            for (var i = yearStart; i < yearEnd; i++) {
                ...
                var currentYearDateTimeJson = MdsPersianDateTimePicker.getDateTimeJson2(MdsPersianDateTimePicker.convertToNumber2(i, selectedDateTimeToShowJson.month, MdsPersianDateTimePicker.getDaysInMonthPersian(i, selectedDateTimeToShowJson.month)));
                var currentYearDisabledAttr = '';
                var yearText = setting.isGregorian ? i.toString() : MdsPersianDateTimePicker.toPersianNumber(i);
                var yearDateNumber = MdsPersianDateTimePicker.convertToNumber2(i, selectedDateTimeToShowJson.month, 1);
        ...
        MdsPersianDateTimePicker.prototype.getYearsBoxHeaderHtml = function (setting, yearStart, yearEnd) {
            ...
            var disabledDateObj = MdsPersianDateTimePicker.getDisabledDateObject(setting);
            var html = MdsPersianDateTimePicker.popoverHeaderSelectYearHtmlTemplate;
        ...
        MdsPersianDateTimePicker.prototype.getDateTimePickerMonthHtml = function (setting, isNextMonth, isPrevMonth) {
            var selectedDateToShow = MdsPersianDateTimePicker.getClonedDate(setting.selectedDateToShow);
            var selectedDateToShowTemp = MdsPersianDateTimePicker.getClonedDate(selectedDateToShow);
            var selectedDateTime = setting.selectedDate != undefined ? MdsPersianDateTimePicker.getClonedDate(setting.selectedDate) : undefined;
            var isNextOrPrevMonth = isNextMonth || isPrevMonth;
            var html = MdsPersianDateTimePicker.dateTimePickerMonthTableHtmlTemplate;
            ...
            var todayDateNumber = MdsPersianDateTimePicker.convertToNumber1(todayDateTimeJson);
            var selectedYear = setting.isGregorian ? dateTimeToShowJson.year.toString() : MdsPersianDateTimePicker.toPersianNumber(dateTimeToShowJson.year);
            var disableBeforeDateTimeNumber = !disableBeforeDateTimeJson ? undefined : MdsPersianDateTimePicker.convertToNumber1(disableBeforeDateTimeJson);
            var disableAfterDateTimeNumber = !disableAfterDateTimeJson ? undefined : MdsPersianDateTimePicker.convertToNumber1(disableAfterDateTimeJson);
            var currentMonthInfo = MdsPersianDateTimePicker.getMonthName(dateTimeToShowJson.month - 1, setting.isGregorian) + ' ' + dateTimeToShowJson.year.toString();
            if (!setting.isGregorian)
            ...
            if (!setting.isGregorian && firstWeekDayNumber != 6 || setting.isGregorian && firstWeekDayNumber != 0) {
                if (setting.isGregorian)
                    firstWeekDayNumber--;
                var previousMonthDateTimeJson = MdsPersianDateTimePicker.addMonthToDateTimeJson(dateTimeToShowJson, -1, setting.isGregorian);
            ...
            // روزهای ماه بعد
            var nextMonthDateTimeJson = MdsPersianDateTimePicker.addMonthToDateTimeJson(dateTimeToShowJson, 1, setting.isGregorian);
        ...
        MdsPersianDateTimePicker.prototype.getPopoverHeaderTitle = function (setting) {
            ...
            if (setting.rangeSelector) {
                var startDate = MdsPersianDateTimePicker.addMonthToDateTime(setting.selectedDateToShow, -setting.rangeSelectorMonthsToShow[0], setting.isGregorian);
                var endDate = MdsPersianDateTimePicker.addMonthToDateTime(setting.selectedDateToShow, setting.rangeSelectorMonthsToShow[1], setting.isGregorian);
                ...
                var startMonthName = MdsPersianDateTimePicker.getMonthName(statDateJson.month - 1, setting.isGregorian);
                var endMonthName = MdsPersianDateTimePicker.getMonthName(endDateJson.month - 1, setting.isGregorian);
        ...
        MdsPersianDateTimePicker.prototype.getDateTimePickerBodyHtml = function (setting) {
            var selectedDateToShow = MdsPersianDateTimePicker.getClonedDate(setting.selectedDateToShow);
            var html = MdsPersianDateTimePicker.dateTimePickerHtmlTemplate;
            ...
            var disabledDays = MdsPersianDateTimePicker.getDisabledDateObject(setting);
            var title = '';
            var todayDateString = '';
            var todayDateTimeJson;
            var selectedDateTimeToShowJson;
        ...
        MdsPersianDateTimePicker.prototype.enableInLineEvents = function () {
            ...
            setTimeout(function () {
                ...
                (_a = dtp.querySelector('[data-mds-dtp-time]')) === null || _a === void 0 ? void 0 : _a.addEventListener('change', _this.timeChanged, false);
        ...
        MdsPersianDateTimePicker.prototype.enableEvents = function () {
            ...
            setTimeout(function () {
                ...
                document.querySelectorAll('[data-mds-dtp-time]').forEach(function (e) { return e.addEventListener('change', _this.timeChanged, false); });
        ...
        MdsPersianDateTimePicker.prototype.disableEvents = function () {
            ...
            (_a = document.querySelectorAll('[data-mds-dtp-time]')) === null || _a === void 0 ? void 0 : _a.forEach(function (e) { return e.removeEventListener('change', _this.timeChanged); });
            ...
            if (dtp != null) {
                ...
                (_b = dtp.querySelectorAll('[data-day]')) === null || _b === void 0 ? void 0 : _b.forEach(function (e) { return e.removeEventListener('mouseenter', _this.hoverOnDays, true); });
            }
        };
        /**
         * نمایش تقویم
        ...
        MdsPersianDateTimePicker.prototype.updateOptions = function (options) {
            ...
            Object.keys(options).forEach(function (key) {
                _this.setting[key] = MdsPersianDateTimePicker.correctOptionValue(key, options[key]);
            });
            MdsPersianDateTimePickerData.set(this.guid, this);
            this.initializeBsPopover(this.setting);
        };
