...
(function ($) {
    ...
    function IsLeapYear(year) {
        return persianDate([year]).isLeapYear();
    }
    ...
    function createDateTimePickerHtml($popoverDescriber, dateTimeInJsonFormat, writeDateString) {
        ...
        var i = 0,
            j = persianDate([dateTimeInJsonFormat.Year, dateTimeInJsonFormat.Month, 01]),
            firstWeekDayNumber = j.getFirstWeekDayOfMonth(dateTimeInJsonFormat.Year, dateTimeInJsonFormat.Month),
            cellNumber = 0,
            tdNumber = 0,
